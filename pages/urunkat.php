...
$satirsayisi         = $mysqli->query("SELECT * FROM urun where katID = $katID AND dil = $dilID AND durum = 1 and bayiozel=0 ORDER BY sira ASC")->num_rows;
    ...
    &quot;filterPosition&quot;: &quot;sidebar&quot;
        ...
        <div class="CollectionMain">
            <div class="CollectionInner">
                                                ...
                                                <div class="ProductItem__Wrapper">
                                                    <a href="<?php echo seocuk($urun['seo']); ?>" class="ProductItem__ImageWrapper ProductItem__ImageWrapper--withAlternateImage">
                                                        <div class="AspectRatio AspectRatio--tall">
                                                            <img class="ProductItem__Image ProductItem__Image--alternate Image--fadeIn lazyautosizes Image--lazyLoaded" data-widths="[200,300,400,600]" data-sizes="auto" alt="<?php echo $urun['baslik'] ?>" data-media-id="25298369839274" data-srcset="uploads/<?php echo $urun['kresim']; ?>" sizes="488px" srcset="uploads/<?php echo $urun['kresim']; ?>">
                ...
                //  $bayiozelsayisi = $mysqli->query("SELECT * FROM urun where katID = $katID AND dil = $dilID AND durum = 1 AND bayiozel=0 ORDER BY sira ASC LIMIT $baslangic, $limit")->num_rows;
                //                 $limit=$limit-$bayiozelsayisi;
                                ...
                                ?>
                                        ...
                                        <?php   } } else {
        $urunlerbayiolmayan = $mysqli->query("SELECT * FROM urun where katID = $katID AND dil = $dilID AND durum = 1 and bayiozel=0 ORDER BY sira ASC LIMIT $baslangic, $limit");
        while ($urunbayiolm = $urunlerbayiolmayan->fetch_array()) {  
                                   
                                        ?>
                                            <div class="Grid__Cell 2/2--phone 1/3--tablet-and-up 1/4--desk">
                                                <div class="ProductItem " style="visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
                                                    <div class="ProductItem__Wrapper">
                                                        <a href="<?php echo seocuk($urunbayiolm['seo']); ?>" class="ProductItem__ImageWrapper ProductItem__ImageWrapper--withAlternateImage">
                                                            <div class="AspectRatio AspectRatio--tall">
                                                                <img class="ProductItem__Image ProductItem__Image--alternate Image--fadeIn lazyautosizes Image--lazyLoaded" data-widths="[200,300,400,600]" data-sizes="auto" alt="<?php echo $urunbayiolm['baslik'] ?>" data-media-id="25298369839274" data-srcset="uploads/<?php echo $urunbayiolm['kresim']; ?>" sizes="488px" srcset="uploads/<?php echo $urunbayiolm['kresim']; ?>">

                                                                <img class="ProductItem__Image Image--fadeIn lazyautosizes Image--lazyLoaded" data-widths="[200,400,600,700,800,900,1000]" data-sizes="auto" alt="<?php echo $urunbayiolm['baslik']; ?>" data-media-id="24890421870762" data-srcset="uploads/<?php echo $urunbayiolm['kresim']; ?>" sizes="488px" srcset="uploads/<?php echo $urunbayiolm['kresim']; ?>">
                                                                <span class="Image__Loader"></span>
                                                        ...
                                                        <div class="ProductItem__Info ProductItem__Info--center">
                                                            <p class="ProductItem__Vendor Heading"><a href="<?php echo seocuk($urunbayiolm['seo']); ?>" title="valentine"><?php echo $urunbayiolm['baslik'];  ?></a></p>
                                                            <h2 class="ProductItem__Title Heading">

                                                                <a href="<?php echo seocuk($urunbayiolm['seo']); ?>"></a>
                                                            </h2>
                                                            <div class="ProductItem__PriceList ProductItem__PriceList--showOnHover Heading">
                                                                <?php
                                                                //fiyat durumu 0 bayi ise herkes ise 1
                                                                if ($urunbayiolm['fiyat'] != 0) {

                                                                    if (@$_SESSION['id']) {

                                                                        $bayi = $mysqli->query("SELECT * FROM uyeler WHERE id='{$_SESSION['id']}' ")->fetch_assoc();
                                                                        if (!empty($bayi['yuzde'])) {
                                                                            $yuzde = yuzdeHesaplama($urunbayiolm['fiyat'], $bayi['yuzde']);
                                                                            $toplam = $urunbayiolm['fiyat'] - $yuzde;
                                                                            $toplamgosterme = $toplam;
                                                                        } else {
                                                                            $toplam = $urunbayiolm['fiyat'];
                                                                            $toplamgosterme = $toplam;
                                                                        }
                                                                ?>
                                                                        <span class="ProductItem__Price Price Text--subdued">
                                                                        ...
                                                                        if ($urunbayiolm['fiyatdurumu'] == 1) {

                                                                        ?>
                                                                            <span class="ProductItem__Price Price Text--subdued">
                                                                                <?php echo number_format($urunbayiolm['fiyat'], 2, ',', '.') . $parabirimi['simge']; ?></span>
                                                                <?php
                                                                        }
                                                                    }
                                                                }
