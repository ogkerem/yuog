        ...
        <header class="pt_urun_kat">
            <div class="Container">
                <div class="SectionHeader SectionHeader--center">
                    <h1 class="SectionHeader__Heading Heading u-h1"><?php echo $urunkat['baslik'];?><?php if($_GET['filter']){ echo ' - '.$renkbule['baslik']; } ?></h1>
                </div>
            </div>
        </header>
                        ...
                        <div class="Collapsible__Inner">
                            <div class="Collapsible__Content">
                                <ul class="Linklist">
                                    ...
                                    ?>
                                        <li class="Linklist__Item ">
                                            <a class="Text--subdued Link Link--primary " href="?filter=<?php echo $renk['id']; ?>">
                            ...
                            <div class="Collapsible__Inner">
                                <div class="Collapsible__Content">
                                    <ul class="Linklist">
                                        ...
                                        ?>
                                            <li class="Linklist__Item ">
                                                <a href="?filter=<?php echo $renks['id']; ?>" class="Text--subdued Link Link--primary " data-action="toggle-tag">
