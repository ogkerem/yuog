   ...
   <!-- <div id="shopify-section-template--15189590081706__pf-33ba1c16" class="shopify-section"> -->
       ...
       <div style="opacity:0; padding-top: 65px;" class="sc-jJoQJp bATEBn __pf" id="__pf" >
                               ...
                               <div class="pf-c" style="--c-xs:12;--c-lg:12">
                                   <div data-pf-type="Column" class="sc-fHeRUh hpWXZa pf-14_">
                                       <div class="sc-ikJyIC iIcPdk pf-15_ pf-r pf-c-ct pf-r-eh" style="--s-xs:4px;--s-sm:3px;--s-md:5px;--s-lg:4px" data-pf-type="Row">
                                           ...
                                           <h3 data-pf-type="Heading" class="sc-jUosCB gcYDfN pf-17_"><span data-pf-type="Text" style="font-size:30px;" class="sc-gyElHZ fxaypC pf-19_"><?php echo dilbak($dilID, 56); ?></span>
                                           </h3>
                           ...
                           <div class="row d-flex justify-content-center ">
                               <?php
                                ...
                                ?>
                                   ...
                                   <div class=" col-md-5">
                               <div data-section-id="pf-c4ca" data-pf-type="Section" class="sc-uojGG cmSGgF pf-30_ " style="margin: auto;">
                                   <div style="--cw:1900px" class="sc-ilfuhL bpQaoh">
                                       <div class="sc-ikJyIC iIcPdk pf-31_ pf-r pf-c-cm pf-r-eh <?php echo ($magaza['sira'] % 2) ? 'd-flex' : ''; ?>" style="--s-xs:0px;--s-sm:15px;--s-lg:10px" data-pf-type="Row">
                                           <a title="<?php echo $magaza['baslik']; ?>" target="_blank" <?php echo ($magaza['son3'] != '') ? $resimURL  : ''; ?>>
                                               <div class="pf-c">
                                           ...
                                           <div class="pf-c " style="--c-xs:12;--c-md:12;--c-lg:12">
                                               <div data-pf-type="Column" class="sc-fHeRUh hpWXZa pf-35_">
                                                   <p class="sc-xiLah fvOkQT pf-36_" data-pf-type="Paragraph">
                                                       ...
                                                       <span data-pf-type="Text" class="sc-gyElHZ fxaypC pf-38_">
                                                           <?php echo $magaza['baslik']; ?>
                                                        
                                                        </span>
                                                           
                                                   </p>
                                                
                                                   <p data-pf-type="Paragraph" style="padding: 2%;">
