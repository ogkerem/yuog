   ...
   <div class="breadcrumb">
                <h1><a href="?sy=<?php echo $bolum; ?>">Katalog</a> >  <?php echo $dilyaz['baslik']; ?>  </h1>
                <ul>
...
<!-- <div class="form-group row">
 ...
 <div class="form-group row">
		<label for="resim" class="col-sm-2 col-form-label"><i class="nav-icon fa fa-file"></i> Dosya * </label>
		<div class="col-sm-2">
	...
	<!-- <div class="form-group row">
		...
		<div class="col-sm-6">
		 ...
		 <small id="passwordHelpBlock" class="ul-form__text form-text "> Kodu veya Linkin birini doldurun her ikisi de  </small>	
		</div>
	</div> 
