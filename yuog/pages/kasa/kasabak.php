...
<div class="card-header text-right bg-transparent">
	...
	<div class="card-body">
		...
		<?php 
		  ...
		  if(!$sayfa) $sayfa=1;
		  $satirsayisi 	= $mysqli->query("select id from kasa where kasaID='$id' ")->num_rows;
		  $toplamsayfa 	= ceil($satirsayisi/$limit); 
		  $baslangic  	= ($sayfa-1)*$limit;
		  $x			= 0;
  
  
			$bak = $mysqli->query("select * from  kasa  where kasaID='$id' order by id desc limit $baslangic,$limit  ");
