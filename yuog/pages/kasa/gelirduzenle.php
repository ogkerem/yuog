   ...
   <div class="breadcrumb">
                <h1><a href="?sy=kasa"> Kasa </a> > Gelir Düzenleme  </h1>
                <ul>
                    <li><a href="index.php">Ana Sayfa</a></li>
                    <li> Gelir Düzenleme </li>
...
<div class="form-group row">
	...
	<div class="form-group row">
		<label for="fiyat" class="col-sm-2 col-form-label"><i class="fa fa-heading"></i> Gelir Miktarı * </label>
		<div class="col-sm-1">
	  <input type="text" name="fiyat" class="form-control" id="fiyat" placeholder="Meblağ" value="<?php echo $yaz['giris']; ?>" required aria-describedby="validationTooltipUsernamePrepend" >  
	...
	<a href="uploads/<?php echo $yaz['resim']; ?>" target="_blank" ><?php echo $yaz['resim']; ?> </a>
   	...
   	<div class="form-group row">
		...
		<div class="col-sm-2">
		 <input type="date" name="tarih" max="31.12.2050" class="form-control " id="tarih"   value="<?php echo substr($yaz['tarih'],0,10); ?>" required >
		</div>	 
	 </div>
	...
	<label for="sira" class="col-sm-2 col-form-label">  </label>
		<div class="col-sm-10">
			<button type="submit" class="btn btn-primary ul-btn__text">Gelir Düzenle</button>
