   ...
   <div class="breadcrumb">
                <h1> <a href="?sy=kasa">Muhasebe (Kasa) </a> > Kasalar </h1>
                <ul>
                    <li><a href="index.php">Ana Sayfa</a></li>
                    <li>Kasa İşlemleri</li>
...
<?php 
	...
	$cbak = $mysqli->query("select * from kasacesit order by sira asc ");
  ...
  <input type="text" name="baslik1" class="form-control" id="validationTooltip01" placeholder="Başlık" value="'.$cyaz['baslik'].'" required="">
		...
		$guncellee = $mysqli->query("update kasacesit set  baslik='$baslik' , sira='$sira'   where id='$gizli' ");
		
				if($guncellee){
		 
		  header("Location:?sy=kasalar&islem=basarili");	
		...
		if(@$_POST['guncellee']=="Sil"){
			...
			$sill = $mysqli->query("delete from kasacesit  where id='$gizli' ");
...
if(@$_POST['yeniekle']=="Yeni İçerik Ekle"){ 
	...
	$gonder  	= $mysqli->query(" insert into kasacesit set 
...
<form action="" method="post" enctype="multipart/form-data" >
	...
	<label for="sira" class="col-sm-2 col-form-label">  </label>
		<div class="col-sm-10">
			<button type="submit" class="btn btn-primary ul-btn__text" value="Yeni İçerik Ekle" name="yeniekle" >Kasa Ekle</button>
