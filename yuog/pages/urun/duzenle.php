	  ...
	  ");
							...
							if ($gonder) {
								...
								if ($ustresimad != "") {
									...
									$kresimsonust 		= 'mini-' . $resimsonad;
									$guncelle 	= $mysqli->query("update $konu set ustresim='$kresimsonust' where id='$id' ");
...
<input type="hidden" name="eskiresimler[]" value="' . $ressyaz['id'] . '"> 
	...
	<br/> 
	 <a class="btn btn-danger text-white btn-rounded resimsill1 " href="#"> Resmi Sil </a> 
								...
								<div class="form-group row">
									<label for="tumsiralama" class="col-sm-2 col-form-label">Koleksiyonlar Sıra </label>
									<div class="col-sm-1">
										<input type="text" name="tumsiralama" class="form-control" id="tumsiralama" placeholder="Tüm Ürünler Sıra" value="<?php echo $yaz['tumsiralama']; ?>">
