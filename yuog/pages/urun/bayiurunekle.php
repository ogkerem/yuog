...
<div class="main-content">
  ...
  ");
                        ...
                        if ($gonder) {
                            ...
                            $yukle2 		= move_uploaded_file($ustkaynak, $rhedef . "/" . $kresimsonust);
                                ...
                                <div class="col-sm-6">
                                    ...
                                    while ($dilyaz1 = $dilbak1->fetch_array()) {
                                        if ($dilyaz1['id'] == $dil) {
                                            ...
                                            echo '<a href="?sy=bayiurunekle&dil=' . $dilyaz1['id'] . '"><button type="button" class="btn btn-raised btn-raised-primary m-1">' . $dilyaz1['baslik'] . '</button></a> ';
                                        } else {

                                            echo '<a href="?sy=bayiurunekle&dil=' . $dilyaz1['id'] . '"><button type="button" class="btn btn-outline-primary m-1">' . $dilyaz1['baslik'] . '</button></a> ';
                                        }
                                    }
                                    ?>
