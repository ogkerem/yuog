   ...
   <div class="breadcrumb">
                <h1><a href="?sy=<?php echo $konu; ?>">Üretim</a>  >  <?php echo $dilyaz['baslik']; ?>  </h1>
                <ul>
...
?>
 ...
 <!--<div class="form-group row">
	...
	<small id="resim" class="ul-form__text form-text "> (Ör.  fa-home ) Bu alan boş olursa icon olarak resim icon kullanılır  </small>
 ...
 <div class="form-group row bg-light p-2" id="yenirsimmm">
	...
	<?php $ressbakk = $mysqli->query("select * from galeri where konu='uretim' && icerikID='$id' && durum='1' "); 
