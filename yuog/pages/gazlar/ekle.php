	...
	$yukle 	= move_uploaded_file($rkaynak,$rhedef."/".$rsonadi);
		...
		// }
		 ...
		 for($zzz=0; $zzz<$gazlarsay; $zzz++){
			 $urunID		= $gazlar[$zzz];
			 $gazlarekle 	= $mysqli->query("insert into gazlarurun (`gazID`, `urunID`) values ('$icerikID' , '$urunID' ) ");
		 }
...
-->
 ...
 <div class="form-group row">
		<label for="resim" class="col-sm-2 col-form-label"><i class="nav-icon fa fa-image"></i> İçerik Resmi ( 370 * 208) * </label>
		<div class="col-sm-2">
