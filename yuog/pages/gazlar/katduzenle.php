	...
	?>
	 ...
	 <div class="breadcrumb">
		<h1><a href="?sy=<?php echo $altkonu; ?>">Servisler</a> > <a href="?sy=<?php echo $konu; ?>"> Kategoriler </a>> <?php echo $dilyaz['baslik']; ?>  </h1>
		<ul>
...
?>
	...
	<img src="<?php echo $rhedef; ?><?php echo $yaz['icon']; ?>" title="  Resim" alt=" Resim" style="background-color:#ddd; width:50px; margin-right:10px; "></a>
