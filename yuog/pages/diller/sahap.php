...
<div class="card-header text-right bg-transparent">
	...
	<a href="?sy=dilekle"><button type="button" class="btn btn-primary btn-icon m-1">
	 <span class="ul-btn__icon"> <i class="fa fa-plus" ></i> </span>
		<span class="ul-btn__text">Dil Ekle</span>
	</button>
	</a>
	
	<a href="?sy=dilsabit"><button type="button" class="btn btn-warning btn-icon m-1">
...
<div class="card-body">
	...
	<div class="table-responsive">
		...
		<?php 
			...
			$bak = $mysqli->query("select * from diller ");
				...
				echo '  <tr>
				<td>'.$yaz['id'].'</td>
	<td><a href="?sy=dilicerik&id='.$yaz['id'].'"><button type="button" class="btn btn-primary ripple m-1">'.$yaz['baslik'].'</button></a></td>				
				<td>'.$yaz['kodu'].'</td>				
				<td>'.$yaz['para'].'</td>				
	<td> <a href="../uploads/'.$yaz['resim'].'" target="_blank" > <img src="../uploads/'.$yaz['resim'].'" title="'.$yaz['baslik'].'" alt="'.$yaz['baslik'].'" style="background-color:#ddd; width:50px; "> </a> </td>				
			 
				<td>'.$yaz['sira'].'</td>	
				<td>'.$durum.'</td>
				
	  <td>
		<a href="?sy=dilduzenle&id='.$yaz['id'].'" class="ul-link-action text-success"  data-toggle="tooltip" data-placement="top" title="Düzenle">
			<i class="i-Edit"></i>
		</a>
 <a href="?sy=dilsil&id='.$yaz['id'].'" class="ul-link-action text-danger mr-1"  data-toggle="tooltip" data-placement="top" title="Sil" onclick=" if ( !confirm(\'Kaydi silmek istediğinizden emin misiniz?\') ) return false;">
