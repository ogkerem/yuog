	...
	$id 	= $_GET['id'];
	$yaz1 	= $mysqli->query("select * from enalt where id='$id' ");
   ...
   <div class="breadcrumb">
                <h1> <a href="?sy=enalt"> Ana Sayfa Sayaç</a> >  <?php echo $dilyaz['baslik']; ?>  </h1>
                <ul>
...
if($_POST){ 
	...
	$gonder  	= $mysqli->query(" update enalt set  
	...
	if($gonder){
	 ...
	 //resimler 
		...
		$guncelle 	= $mysqli->query("update enalt set kresim='$resimsonad' where id='$id' ");
	...
	if($resimad!=""){ 	 
		...
		$yukle 		= move_uploaded_file($kaynak,$rhedef."/".$resimsonad); 
		$guncelle 	= $mysqli->query("update enalt set resim='$resimsonad' where id='$id' ");
	}
...
<!--<div class="form-group row">
 ...
 <div class="form-group row">
		<label for="kresim" class="col-sm-2 col-form-label">  Resim * ( 32 * 32 ) </label>
		<div class="col-sm-3">
	 ...
	 <img src="../uploads/<?php echo $yaz['kresim']; ?>" title="Büyük Resim" alt="Büyük Resim" style="background-color:#ddd; width:100px; "></a>
...
-->
 ...
 <div class="form-group row">
	 ...
	 <a href="../uploads/enalt/<?php echo $yaz['resim']; ?>" target="_blank" >
	 <img src="../uploads/enalt/<?php echo $yaz['resim']; ?>" title="Büyük Resim" alt="Büyük Resim" style="background-color:#ddd; width:100px; "></a>
...
-->
 	...
 	<div class="form-group row">
		...
		<div class="col-sm-6">
		 <input type="text" name="vlink" class="form-control" id="vlink" placeholder="Video Link" value="<?php echo $yaz['vlink']; ?>" required >
		</div>
	</div>
	...
	<!-- <div class="form-group row">
		<label for="bira" class="col-sm-2 col-form-label"> Birinci İçerik * </label>
		<div class="col-sm-6">
		<textarea name="bira"  class="form-control" id="bira" cols="10" rows="2" placeholder="Birinci İçerik" required ><?php echo $yaz['bira']; ?></textarea>
 	 ...
 	 <div class="form-group row">
		<label for="birb" class="col-sm-2 col-form-label">Birinci Sayı * </label>
		<div class="col-sm-1">
		 <input type="text" name="birb" class="form-control" id="birb" placeholder="" value="<?php echo $yaz['birb']; ?>" required >
		</div>
	</div>
...
<!--	<div class="form-group row">
		...
		<div class="col-sm-6">
		<textarea name="ikia"  class="form-control" id="ikia" cols="10" rows="2" placeholder="İkinci İçerik" required ><?php echo $yaz['ikia']; ?></textarea>
 	 ...
 	 <div class="form-group row">
		<label for="ikib" class="col-sm-2 col-form-label">İkinci Sayı * </label>
		<div class="col-sm-1">
		 <input type="text" name="ikib" class="form-control" id="ikib" placeholder="" value="<?php echo $yaz['ikib']; ?>" required >
		</div>
	</div>
	...
	<!-- <div class="form-group row">
		...
		<div class="col-sm-6">
		<textarea name="uca"  class="form-control" id="uca" cols="10" rows="2" placeholder="Üçüncü İçerik" required ><?php echo $yaz['uca']; ?></textarea>
 	 ...
 	 <div class="form-group row">
		<label for="ucb" class="col-sm-2 col-form-label">Üçüncü Sayı * </label>
		<div class="col-sm-1">
		 <input type="text" name="ucb" class="form-control" id="ucb" placeholder="" value="<?php echo $yaz['ucb']; ?>" required >
		</div>
	</div>
