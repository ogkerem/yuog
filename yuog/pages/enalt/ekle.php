...
if($_POST){ 
	...
	$gonder  	= $mysqli->query(" insert into enalt set 
...
<div class="form-group row">
	...
	echo '<a href="?sy=enaltekle&dil='.$dilyaz1['id'].'"><button type="button" class="btn btn-raised btn-raised-primary m-1">'.$dilyaz1['baslik'].'</button></a> ';
...
<!-- <div class="form-group row">
 ...
 <div class="form-group row">
		<label for="icon" class="col-sm-2 col-form-label">   Resim * ( 32 * 32 ) </label>
		<div class="col-sm-2">
...
<!--	  <div class="form-group row">
	...
	<!-- <div class="form-group row">
		...
		<div class="col-sm-6">
		<textarea name="bira"  class="form-control" id="bira" cols="10" rows="2" placeholder="Birinci İçerik" required ></textarea>
 	 ...
 	 <div class="form-group row">
		...
		<div class="col-sm-1">
		 <input type="text" name="birb" class="form-control" id="birb" placeholder="" value="" required >
		</div>
	</div>
...
<!--	<div class="form-group row">
 	 ...
 	 <div class="form-group row">
		...
		<div class="col-sm-1">
		 <input type="text" name="ikib" class="form-control" id="ikib" placeholder="" value="" required >
		</div>
	</div>
...
<!-- <div class="form-group row">
 	 ...
 	 <div class="form-group row">
		...
		<div class="col-sm-1">
		 <input type="text" name="ucb" class="form-control" id="ucb" placeholder="" value="" required >
		</div>
	</div>
