   ...
   <div class="breadcrumb">
    ...
    <h1> <a href="?sy=bilgi&konu=<?php echo $konu; ?>">  Menü Genel Açıklama </a> > <a href="?sy=sahap&sistem=<?php echo $sistem; ?>"> <?php echo $konu; ?> </a>  > <?php echo $dilyaz['baslik']; ?> </h1>
