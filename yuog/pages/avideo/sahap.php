...
<div class="breadcrumb">
    <h1> <a href="#"> Ana Sayfa Akademi </a></h1>
    <ul>
...
<div class="card-header text-right bg-transparent">
	...
	<a href="?sy=avideoekle"><button type="button" class="btn btn-primary btn-icon m-1">
	...
	<a href="?sy=cikisnokta"><button type="button" class="btn btn-light btn-icon m-1">
	 <span class="ul-btn__icon"> <i class="fa fa-share" ></i> </span>
		...
		<?php 
			...
			$bak = $mysqli->query("select * from avideo ");
			...
			$dilyaz = $dilbak->fetch_array();
				...
				<td>'.$durum.'</td>
				  ...
				  <td>
			 <a href="?sy=avideoduzenle&id='.$yaz['id'].'" class="ul-link-action text-success"  data-toggle="tooltip" data-placement="top" title="Düzenle">
						<i class="i-Edit"></i>
					</a>
			 <a href="?sy=avideosil&id='.$yaz['id'].'" class="ul-link-action text-danger mr-1"  data-toggle="tooltip" data-placement="top" title="Sil" onclick=" if ( !confirm(\'Kaydi silmek istediğinizden emin misiniz?\') ) return false;">
