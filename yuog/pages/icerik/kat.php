...
<div class="breadcrumb">
	 ...
	 <h1> <a href="?sy=<?php echo $konu; ?>"> <?php echo $konu; ?> </a> > kategoriler </h1>
    <ul>
...
<div class="card-header text-right bg-transparent">
	...
	<a href="?sy=<?php echo $kat; ?>ekle"><button type="button" class="btn btn-primary btn-icon m-1">
	...
	<a href="?sy=cikisnokta"><button type="button" class="btn btn-light btn-icon m-1">
	 <span class="ul-btn__icon"> <i class="fa fa-share" ></i> </span>
		...
		<?php 
			...
			$bak = $mysqli->query("select * from  icerikkat where konu='$konu' ");
		...
		$dilyaz = $dilbak->fetch_array();
				...
				<td>'.$durum.'</td>
				  ...
				  <td>
 <a href="?sy='.$kat.'duzenle&id='.$yaz['id'].'" class="ul-link-action text-success"  data-toggle="tooltip" data-placement="top" title="Düzenle">
						<i class="i-Edit"></i>
					</a>
					
		<a href="?sy='.$kat.'sil&id='.$yaz['id'].'" class="ul-link-action text-danger mr-1"  data-toggle="tooltip" data-placement="top" title="Sil" onclick=" if ( !confirm(\'Kaydi silmek istediğinizden emin misiniz?\') ) return false;">
