...
if($_POST){ 
	...
	$gonder  	= $mysqli->query(" insert into icerikkat set 
	...
	if($gonder){
		...
		$esay =  count($ebakp);
		  	...
		  	for($yy=0; $yy < $esay; $yy++){
			$etiket1  = $ebakp[$yy];
		$etiketekle = $mysqli->query ("insert into etiket (`baslik`, `seo`, `konu`, `konuID` ) values ('$etiket1' , '$seoID' , '$kat' , '$icerikID' ) ");
...
<div class="form-group row">
  ...
  <div class="form-group row">
		<label for="resim" class="col-sm-2 col-form-label"> <i class="nav-icon fa fa-image"></i> Üst Resim  ( 1920 * xxx)   </label>
		<div class="col-sm-2">
 ...
 <div class="form-group row">
		<label for="resim" class="col-sm-2 col-form-label"><i class="nav-icon fa fa-image"></i> İçerik Resmi   </label>
		<div class="col-sm-2">
