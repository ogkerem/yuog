	...
	$id 	= $_GET['id'];
	$yaz 	= $mysqli->query("select * from icerikkat where id='$id' ")->fetch_array();
...
<h1><a href="?sy=<?php echo $konu; ?>"><?php echo $konu; ?></a> > <a href="?sy=<?php echo $kat; ?>"> kategoriler </a>> <?php echo $dilyaz['baslik']; ?>  </h1>
<ul>
...
if($_POST){ 
	...
	$gonder  	= $mysqli->query(" update icerikkat set  
	...
	if($gonder){
	 ...
	 //resimler 
		...
		$guncelle 	= $mysqli->query("update icerikkat set ustresim='$resimsonad' where id='$id' ");
	}	
	...
	if($kresimad!=""){ 	 
		...
		$guncelle 		= $mysqli->query("update icerikkat set kresim='$resimsonad1' where id='$id' ");	
	}
	...
	if($resimad!=""){ 	 
		...
		$guncelle 	= $mysqli->query("update icerikkat set resim='$resimsonad' where id='$id' ");
	}
...
<div class="form-group row">
	...
	<div class="col-sm-6">
	 ...
	 <div class="form-group row">
		<label for="ustresim" class="col-sm-2 col-form-label"><i class="nav-icon fa fa-image"></i> Üst Resim   ( 1920 * xxx ) </label>
		<div class="col-sm-3">
