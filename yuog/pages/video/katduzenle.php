	...
	?>
	 ...
	 <div class="breadcrumb">
		<h1><a href="?sy=video">Videolar</a> > <a href="?sy=<?php echo $konu; ?>"> Kategoriler </a>> <?php echo $dilyaz['baslik']; ?>  </h1>
		<ul>
...
?>
 ...
 <div class="form-group row bg-light p-2" id="yenirsimmm">
	...
	<?php $ressbakk = $mysqli->query("select * from galeri where konu='video' && icerikID='$id' && durum='1' "); 
