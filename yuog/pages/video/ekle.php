   ...
   <div class="breadcrumb">
	<h1><a href="?sy=<?php echo $bolum; ?>">Video Galeri</a> >  <?php echo $dilyaz['baslik']; ?>  </h1>
	<ul>
...
if($_POST){ 
	...
	$katID				= addslashes(trim($_POST['katID']));
...
<div class="form-group row">
	...
	echo '<a href="?sy='.$bolum.'ekle&dil='.$dilyaz1['id'].'"><button type="button" class="btn btn-raised btn-raised-primary m-1">'.$dilyaz1['baslik'].'</button></a> ';
	
			} else {
			
	echo '<a href="?sy='.$bolum.'ekle&dil='.$dilyaz1['id'].'"><button type="button" class="btn btn-outline-primary m-1">'.$dilyaz1['baslik'].'</button></a> ';
...
<div class="form-group row">
 ...
 <div class="form-group row">
  ...
  <div class="form-group row">
		...
		<div class="col-sm-10">
<textarea name="onyazi" class="form-control" id="onyazi" cols="50" rows="2" placeholder="Video Kodu" required ></textarea>
			  <small id="passwordHelpBlock" class="ul-form__text form-text "> Sadece embed kodu </small>	
		</div>
	</div>    
...
<!-- <div class="form-group row">
 ...
 <div class="form-group row">
	...
	<div class="form-group row">
		<label for="vaciklama" class="col-sm-2 col-form-label">Video Kodu * </label>
		<div class="col-sm-6">
		 <input type="text" name="vaciklama" class="form-control" id="vaciklama" placeholder="Video Kodu" value=""  >
		</div>
	</div>-->
