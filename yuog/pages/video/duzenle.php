   ...
   <div class="breadcrumb">
                <h1><a href="?sy=<?php echo $konu; ?>">Video Galeri</a>  >  <?php echo $dilyaz['baslik']; ?>  </h1>
                <ul>
...
<div class="form-group row">
	...
	<div class="form-group row">
		...
		<div class="col-sm-2">
		  ...
		  <label for="ustkatID"  > </label>
			...
			<?php 
				$ukat  = $mysqli->query("select * from $kat where dil='$dil' order by sira asc ");
					while($uyaz = $ukat->fetch_array()){
					
				if($uyaz['id']==$yaz['katID']){
 ...
 <div class="form-group row">
  ...
  <div class="form-group row">
		<label for="onyazi" class="col-sm-2 col-form-label">Video Kodu * </label>
		<div class="col-sm-10">
		<textarea name="onyazi" class="form-control" id="onyazi" cols="50" rows="2" placeholder="Video Kodu" ><?php echo $yaz['onyazi']; ?></textarea>
...
<!-- <div class="form-group row">
 ...
 <input type="text" name="tarih"  class="form-control" id="datepicker" autocomplete="off" placeholder="Tarih" value="<?php echo $yaz['tarih']; ?>" required > 
   ...
   <script>
	...
	<img src="../uploads/<?php echo $konu; ?>/<?php echo $yaz['kresim']; ?>" title="Küçük Resim" alt="Küçük Resim" style="background-color:#ddd; width:50px; "></a>
	  ...
	  <div class="form-group row">
		<label for="resim" class="col-sm-2 col-form-label"><i class="nav-icon fa fa-image"></i> PDF *  </label>
		<div class="col-sm-3">
		  <input type="file" name="resim" class="form-control" id="resim" placeholder=""   > 
		  <small id="resim" class="ul-form__text form-text "> Yeni dosya istemiyorsanız işlem yapmayınız </small>	
		  <input type="hidden" name="gresim"  value="<?php echo $yaz['resim']; ?>"   > 
		 
			 				
		</div>
	<a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['resim']; ?>" target="_blank" ><?php echo $yaz['resim']; ?></a>
	</div>
	 -->
...
<!--
	 ...
	 <div class="form-group row">
		...
		<div class="col-sm-6">
		 ...
		 <small id="passwordHelpBlock" class="ul-form__text form-text "> Link varsa kodu çalışmaz </small>	
		</div>
	</div>
