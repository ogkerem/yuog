   ...
   <div class="breadcrumb">
                <h1><a href="?sy=<?php echo $konu; ?>"> Ekip </a> > <?php echo $dilyaz['baslik']; ?>  </h1>
                <ul>
...
<div class="form-group row">
		<label for="baslik" class="col-sm-2 col-form-label"><i class="fa fa-heading"></i> Ad Soyad * </label>
		<div class="col-sm-6">
		 <input type="text" name="baslik" class="form-control" id="baslik" placeholder="Ad Soyad" value="" required >
		</div>
	</div>
...
<div class="form-group row">
		...
		<div class="col-sm-1">
		 <input type="text" name="fiyat" class="form-control" id="fiyat" placeholder="Fiyat" value="" required aria-describedby="validationTooltipUsernamePrepend" >  
...
<!--	  <div class="form-group row">
 ...
 <div class="form-group row">
  ...
  <div class="form-group row">
		<label for="onyazi" class="col-sm-2 col-form-label"> Branş </label>
		<div class="col-sm-10">
		<textarea name="onyazi" class="form-control" id="onyazi" cols="50" rows="2" placeholder="Branş" ></textarea>
 ...
 <div class="form-group row">
		<label for="resim" class="col-sm-2 col-form-label"><i class="nav-icon fa fa-image"></i> İçerik Resmi ( 401 * 594) * </label>
		<div class="col-sm-2">
