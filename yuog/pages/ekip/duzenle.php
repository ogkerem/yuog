...
<div class="form-group row">
		<label for="baslik" class="col-sm-2 col-form-label">Ad Soyad * </label>
		<div class="col-sm-6">
		 <input type="text" name="baslik" class="form-control" id="baslik" placeholder="Ad Soyad " value="<?php echo $yaz['baslik']; ?>" required >
		</div>
	</div>
...
?>
 ...
 <img src="../uploads/<?php echo $konu; ?>/<?php echo $yaz['icon']; ?>" title="  Resim" alt=" Resim" style="background-color:#ddd; width:50px; margin-right:20px; "></a>
  ...
  <div class="form-group row">
		...
		<div class="col-sm-10">
		<textarea name="onyazi" class="form-control" id="onyazi" cols="50" rows="2" placeholder="Branş" ><?php echo $yaz['onyazi']; ?></textarea>
	...
	<img src="../uploads/<?php echo $yaz['kresim']; ?>" title="Küçük Resim" alt="Küçük Resim" style="background-color:#ddd; width:50px; "></a>
	  ...
	  <div class="form-group row">
		<label for="resim" class="col-sm-2 col-form-label"><i class="nav-icon fa fa-image"></i> Resim  (  401 * 594)*  </label>
		<div class="col-sm-3">
