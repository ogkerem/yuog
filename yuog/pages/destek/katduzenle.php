	...
	?>
	 ...
	 <div class="breadcrumb">
		<h1><a href="?sy=<?php echo $altkonu; ?>"> Sunucu </a> > <a href="?sy=<?php echo $konu; ?>"> Kategoriler </a>> <?php echo $dilyaz['baslik']; ?>  </h1>
		<ul>
...
if($_POST){ 
	...
	$yukle 	= move_uploaded_file($rkaynak,$rhedef."/".$rsonadi);
	 ...
	 header("Location:?sy=".$konu."&katID=".$katID."&islem=basarili"); exit;	
...
?>
	...
	<img loading="lazy" src="<?php echo $rhedef; ?><?php echo $yaz['icon']; ?>" title="  Resim" alt=" Resim" style="background-color:#ddd; width:50px; margin-right:10px; "></a>
	...
	<small id="resim" class="ul-form__text form-text "> (Ör.  fa fa-home veya flaticon-clipboard bg-icon ) boş olursa icon olarak resim kullanılır  </small>
	 ...
	 <div class="form-group row">
		<label for="ustresim" class="col-sm-2 col-form-label"><i class="nav-icon fa fa-image"></i> Bölümler İcon   ( 45 * 45) </label>
		<div class="col-sm-3">
	 ...
	 <img loading="lazy" src="<?php echo $rhedef; ?>/<?php echo $yaz['ustresim']; ?>" title="Büyük Resim" alt="Büyük Resim" style="background-color:#ddd; width:45px; "></a>
  ...
  <div class="form-group row">
	...
	<img loading="lazy" src="<?php echo $rhedef; ?><?php echo $yaz['kresim']; ?>" title="Küçük Resim" alt="Küçük Resim" style="background-color:#ddd; width:50px; "></a>
	</div>
	...
	<img loading="lazy" src="<?php echo $rhedef; ?><?php echo $yaz['resim']; ?>" title=" Resim" alt=" Resim" style="background-color:#ddd; width:50px; "></a>
	</div>
  ...
  <div class="form-group row">
	...
	<img loading="lazy" src="../uploads/<?php echo $konu; ?>/<?php echo $yaz['vresim']; ?>" title=" Resim" alt=" Resim" style="background-color:#ddd; width:50px; "></a>
	</div> 
...
<img loading="lazy" src="../uploads/'.$konu.'/'.$ressyaz['resim'].'" title="Büyük Resim" alt="Büyük Resim" style="background-color:#ddd;  height:100px; "></a>
<input type="hidden" name="eskiresimler[]" value="'.$ressyaz['id'].'"> 
	...
	<?php 
		...
		$projebak = $mysqli->query("select * from bolumlerproje where proje='$projeID' && katID='$id' ");
