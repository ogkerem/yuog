	...
	<div class="main-content">
		...
		<div class="breadcrumb">
			<h1><a href="?sy=destek">Destek </a> > Destek Kategoriler asd </h1>
			<ul>
						...
						?>
							...
							<form action="" method="post" enctype="multipart/form-data">
								...
								<div class="form-group row">
									<label for="dil" class="col-sm-2 col-form-label">Dil * </label>
									<div class="col-sm-3">
										<select name="dil" id="dil" class="form-control">
											<?php
											$dilsor = $mysqli->query("SELECT * FROM diller ORDER BY sira ASC");
											foreach ($dilsor as $dil) {
											?>
												<option value="<?php echo $dil['id']; ?>"><?php echo $dil['baslik']; ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
