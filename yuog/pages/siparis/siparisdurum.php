<?php 
 ...
 function cifttirnak($baslik){
     
     $al1 	= str_replace('"','\"',$baslik); 
     return $al1;
 }  
    ...
    <div class="breadcrumb">
       <h1><a href="?sy=siparis"> Siparişler </a> > Sipariş Durumları  </h1>
     <ul>
 ...
 <?php              
     $cbak = $mysqli->query("select * from  siparisdurum  order by sira asc ");
         while($cyaz = $cbak->fetch_array()){
             ...
             <div class="col-md-3 mb-3">
                 ...
                 <input type="text" class="form-control" id="baslik" name="baslik1" placeholder="Başlık" value="'.$cyaz['baslik'].'"  >
         ...
         $guncellee = $mysqli->query("update siparisdurum set  baslik='$baslik' ,  sira='$sira' where id='$gizli' ");
         
                 if($guncellee){
          
 
      
           header("Location:?sy=siparisdurum&islem=basarili");	
         ...
         if(@$_POST['guncellee']=="Sil"){
             ...
             $sill = $mysqli->query("delete from siparisdurum where id='$gizli' ");
 ...
 if(@$_POST['yeniekle']=="Yeni İçerik Ekle"){ 
     ...
     $gonder  	= $mysqli->query(" insert into siparisdurum set 
