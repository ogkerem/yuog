...
//	echo 'sıra ::: '.$rsira[2];
	...
	$esgun 			= $mysqli->query("update galeri set durum='1', sira='$rsira1' where icerikID='$id' && id='$resID' && konu='$konu'   "); 
...
<div class="form-group row">
		...
		<div class="col-sm-2">
	<input type="date" name="baslangic" max="31.12.2050" class="form-control " id="baslangic" placeholder="Tarih" value="<?php echo $yaz['baslangic']; ?>"  >
		</div>	
...
-->
	  ...
	  <div class="form-group row">
		...
		<div class="col-sm-3">
		  ...
		  <small id="resim" class="ul-form__text form-text "> Yeni resim istemiyorsanız işlem yapmayınız , 450 * 340 veya katları</small>
...
<img src="../uploads/'.$ressyaz['resim'].'" title="Büyük Resim" alt="Büyük Resim" style="background-color:#ddd;  height:100px; "></a></br>	
<input type="text" name="rsira[]" value="'.$ressyaz['sira'].'" size="1"> 
