...
<td><a href="?sy=urundokumankat&id='.$yaz['id'].'"  ><button type="button" class="btn btn-primary ripple m-1">Dökümanlar</button></a></td>
 <td><a href="?sy=urunsartnamekat&id='.$yaz['id'].'"  ><button type="button" class="btn btn-warning m-1">Şartname</button></a></td> 
<td><a href="?sy=urunaksesuarkat&id='.$yaz['id'].'"  ><button type="button" class="btn btn-light m-1">Aksesuarlar</button></a></td>
<td><a href="?sy=urunvideokat&id='.$yaz['id'].'" ><button type="button" class="btn btn-info m-1">Videolar</button></a></td>
