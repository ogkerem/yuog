<?php 
 ...
 //		$seoyaz = $seobul->fetch_array();
   ...
   <input type="text" name="renk"  maxlength="7" id="renk" class="form-control jscolor" placeholder="Renk" value="'.$cyaz['renk'].'" required="">
   ...
   <input type="text" name="seo1" class="form-control" id="validationTooltip01" placeholder="Seo Url" value="'.$seoyaz['seo'].'" required="">
    <input type="hidden" class="form-control"  name="seoidd"   value="'.$seoID.'"  >
         ...
         $guncellee = $mysqli->query("update $kategori set katID='$katID', baslik='$baslik' , renk='$renk', sira='$sira' , dil='$dil' where id='$gizli' ");
 ...
 <div class="form-group row">
     ...
     <div class="form-group row">
		<label for="renk" class="col-sm-2 col-form-label"><i class="fa fa-colors"></i> Renk Kodu </label>
		<div class="col-sm-1">
