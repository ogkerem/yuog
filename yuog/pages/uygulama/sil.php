<?php 
   ...
   <div class="breadcrumb">
	...
	$sil 		= $mysqli->query("delete from $konu where id='$id'");
		...
		unlink($rhedef.$pdf);
		unlink($rhedef.$icon);
		$etsil = $mysqli->query("delete from uygulamasektorler where  icerikID='$id'  "); 
		$etsil = $mysqli->query("delete from uygulamabolum where  icerikID='$id'  "); 
		$etsil = $mysqli->query("delete from uygulamaurun where  icerikID='$id'  "); 
