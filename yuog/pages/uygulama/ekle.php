...
if($_POST){ 
	...
	$yukle 	= move_uploaded_file($rkaynak,$rhedef."/".$rsonadi);
		...
		for($pp=0; $pp<$projesay; $pp++){
			$proje1	= $proje[$pp];
			$bolumekle = $mysqli->query("insert into  uygulamaurun (`proje`, `icerikID`) values ('$proje1' , '$icerikID' ) ");
		}
 
		$bolumsay 	= count($bolum);
		 
		for($pp=0; $pp<$bolumsay; $pp++){
			$proje1	= $bolum[$pp];
			$bolumekle = $mysqli->query("insert into  uygulamabolum (`proje`, `icerikID`) values ('$proje1' , '$icerikID' ) ");
		}
 
		$sektorsay 	= count($sektor);
		 
		for($pp=0; $pp<$bolumsay; $pp++){
			$proje1	= $sektor[$pp];
			$bolumekle = $mysqli->query("insert into  uygulamasektorler (`proje`, `icerikID`) values ('$proje1' , '$icerikID' ) ");
		}
...
<!--	<div class="form-group row">
 ...
 <div class="form-group row">
	...
	<?php 
		...
		<input type="checkbox" name="bolum[]" value="'.$pyaz['id'].'" >
	...
	<?php 
		...
		<input type="checkbox" name="sektor[]" value="'.$pyaz['id'].'" >
		<span>'.$pyaz['baslik'].'</span>
		<span class="checkmark"></span> 
		</label>';
	...
	<hr/>
		...
		<div class="col-sm-3">
		 <input type="text" name="yetkili" class="form-control" id="yetkili" placeholder="Yetkili Ad Soyad" value="" >
		</div>
		<div class="col-sm-2">
		 <input type="text" name="ymail" class="form-control" id="ymail" placeholder="Mail Adresi" value="" >
		</div>
		<div class="col-sm-2">
	...
	<hr/>
		...
		<div class="col-sm-2">
		 <input type="date" name="baslangic" max="31.12.2050" class="form-control " id="baslangic" placeholder="Proje Başlangıç" value=""  >
		</div>	
		
		- <div class="col-sm-2">
		 <input type="date" name="bitis" max="31.12.2050" class="form-control" id="bitis" placeholder="Proje Bitiş" value=""  >
		</div>
		</div>
		...
		<div class="col-sm-4">
		 <input type="text" name="firma" class="form-control" id="firma" placeholder="İlgili Firma" value="" >
		</div>
	</div>
