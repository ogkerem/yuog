				...
				<div class="col-md-12 mb-4">
					<div class="card text-left">
						<div class="card-header text-right bg-transparent">
							...
							<a href="?sy=bannerekle"><button type="button" class="btn btn-primary btn-icon m-1">
									<span class="ul-btn__icon"> <i class="fa fa-plus"></i> </span>
									<span class="ul-btn__text">Banner Ekle</span>
								</button>
							</a>
							...
							<div class="table-responsive">
								<table id="ul-contact-list" class="display table " style="width:100%">
									...
									<tbody>
										...
										$bak = $mysqli->query("select * from banner ");
										...
										?>
											<tr>
												<td>'<?php echo $yaz['sira']; ?>'</td>

												<td>
													<?php if ($yaz['resim'] != "") { ?>
														<a href="../uploads/<?php echo $yaz['resim']; ?>" target="_blank">
															<img height="80" src="../uploads/<?php echo $yaz['resim']; ?>"> </a>
													<?php
													} else if ($yaz['resim'] == "") {
													echo "<b>Video</b>";
													}
												...
												<td><?php echo $yaz['ustbaslik']; ?></td>
												<td><?php echo $dilyaz['baslik']; ?></td>
												<td><?php echo $durum; ?></td>

												<td>
													<a href="?sy=bannerduzenle&id=<?php echo $yaz['id']; ?>" class="ul-link-action text-success" data-toggle="tooltip" data-placement="top" title="Düzenle">
														<i class="i-Edit"></i>
													</a>
													<a href="?sy=bannersil&id=<?php echo $yaz['id']; ?>" class="ul-link-action text-danger mr-1" data-toggle="tooltip" data-placement="top" title="Sil" onclick=" if ( !confirm(\'Kaydi silmek istediğinizden emin misiniz?\') ) return false;">
