	...
	$id 	= $_GET['id'];
	$yaz1 	= $mysqli->query("select * from servis where id='$id' ");
				...
				<div class="card mb-5">
					<div class="card-body">
						...
						if ($_POST) {
							...
							$gonder  	= $mysqli->query(" update servis set 
	  ...
	  ");
							...
							if ($gonder) {
								...
								if ($resimad != "") {
									...
									$guncelle 	= $mysqli->query("update servis set resim='$resimsonad' where id='$id' ");
								}
								...
								if ($kresimad != "") {
									...
									$guncelle 		= $mysqli->query("update servis set kresim='$resimsonad1' where id='$id' ");
								}
								...
								$esay =   count($ebakp);
								$etsil = $mysqli->query("delete from etiket where konu='servis' && konuID='$id'  ");

								for ($yy = 0; $yy < $esay; $yy++) {
									$etiket1  = trim($ebakp[$yy]);
									if ($etiket1 != "") {
										$etiketekle = $mysqli->query("insert into etiket (`baslik`, `seo`, `konu`, `konuID` ) values ('$etiket1' , '$seoID' , 'servis' , '$id' ) ");
									}
								}
						...
						?>
							...
							<form action="" method="post" enctype="multipart/form-data">
								...
								<div class="form-group row">
									...
									<a href="../uploads/servis/<?php echo $yaz['kresim']; ?>" target="_blank">
										<img src="../uploads/servis/<?php echo $yaz['kresim']; ?>" title="Küçük Resim" alt="Küçük Resim" style="background-color:#ddd; width:50px; "></a>
								</div>
								...
								<div class="form-group row">
									...
									<a href="../uploads/servis/<?php echo $yaz['resim']; ?>" target="_blank">
										<img src="../uploads/servis/<?php echo $yaz['resim']; ?>" title="Büyük Resim" alt="Büyük Resim" style="background-color:#ddd; width:100px; "></a>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<input type="text" name="etiket" class="form-control" id="etiket" placeholder="Etiketler" value="<?php $etbak = $mysqli->query("select * from etiket where konu='servis' && konuID='$id'  ");
