...
-->
 ...
 <!-- <div class="form-group row bg-light p-2" id="yenirsimmm">
	...
	<?php $ressbakk = $mysqli->query("select * from galeri where konu='iconkat' && icerikID='$id' && durum='1' "); 
...
<input type="hidden" name="eskiresimler[]" value="'.$ressyaz['id'].'"> 
	...
	<?php 
		...
		$benbak1 = $mysqli->query("select * from urungaz where katID='$id' && gazID='$gbenzer' ")->num_rows;	
		if($benbak1>0){			
			$bennn1 = 'checked';
		} else {
			$bennn1 = '';
