...
//		$seoyaz = $seobul->fetch_array();
  ...
  <input type="text" name="baslik1" class="form-control" id="validationTooltip01" placeholder="Başlık" value="'.$cyaz['baslik'].'" required="">
				...
				<div class="col-md-2 mb-2">
	 <a href="../uploads/'.$cyaz['dosya'].'" target="_blank"><img src="../uploads/'.$cyaz['dosya'].'" style="height:80px;"></a>			 
...
//		$rhedef				= "../uploads/";
		...
		$guncellee = $mysqli->query("update urunaksesuar set   baslik='$baslik' , onyazi='$onyazi' , sira='$sira' , dil='$dil' where id='$gizli' ");
...
//		$guncelle 	= $mysqli->query("update urunaksesuar set dosya='$resimad' where id='$gizli' ");
//						
//						
//					}
...
header("Location:?sy=".$kategori."&id=".$id."&dil=".$dil."&islem=basarili");
	...
	$resim1		= $mysqli->query("select * from $kategori where id='$gizli'");
