	...
	$kategori 	= $konu."video";
 	...
 	$id = @$_GET['id']; 
	$urunyaz = $mysqli->query("select * from urun where id='$id' ")->fetch_array();
   ...
   <div class="breadcrumb">
	  <h1><a href="?sy=<?php echo $konu; ?>"> Ürünler</a> > <a href="?sy=urunduzenle&id=<?php echo $urunyaz['id']; ?>"> <?php echo $urunyaz['baslik']; ?></a> > <?php echo $dilyaz['baslik']; ?>  </h1>
...
<?php 
	...
	$cbak = $mysqli->query("select * from   urunvideo  where urunID='$id' order by sira asc ");
...
//		$rhedef				= "../uploads/";
		...
		$guncellee = $mysqli->query("update urunvideo set   baslik='$baslik' , onyazi='$onyazi' ,  video='$video' , sira='$sira' , dil='$dil' where id='$gizli' ");
