	...
	?>
	 ...
	 <div class="breadcrumb">
		<h1><a href="?sy=arge">Ar&Ge</a> > <a href="?sy=<?php echo $konu; ?>"> Kategoriler </a>> <?php echo $dilyaz['baslik']; ?>  </h1>
		<ul>
...
?>
 ...
 <div class="form-group row bg-light p-2" id="yenirsimmm">
	...
	<?php $ressbakk = $mysqli->query("select * from galeri where konu='arge' && icerikID='$id' && durum='1' "); 
