   ...
   <div class="breadcrumb">
                <h1><a href="?sy=<?php echo $konu; ?>">Sözleşmeler</a>  >  <?php echo $dilyaz['baslik']; ?>  </h1>
                <ul>
...
<div class="form-group row">
 	...
 	<script type="text/javascript"> 
		$(function(){
			$("select[name=ustkatID]").change(function(){
				...
				$.ajax({
					url: "pages/sozlesme/ukatbak.php",
					type: "POST",
 ...
 <div class="form-group row">
	 ...
	 <a href="../uploads/<?php echo $yaz['ustresim']; ?>" tsozlesmet="_blank" >
	...
	<a href="../uploads/<?php echo $yaz['icon']; ?>" tsozlesmet="_blank" >
...
<!--	  <div class="form-group row">
 ...
 <div class="form-group row">
	...
	<a href="../uploads/<?php echo $yaz['vresim']; ?>" tsozlesmet="_blank" >
...
<input type="hidden" name="eskidosyalar[]" value="'.$ressyaz['id'].'"> 
 ...
 <div class="form-group row bg-light p-2" id="yenirsimmm">
	...
	<?php $ressbakk = $mysqli->query("select * from galeri where konu='sozlesme' && icerikID='$id' && durum='1' "); 
