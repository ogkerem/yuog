...
if($_POST){ 
	...
	if($gonder){
		...
		// bu alan yerine linkedine göndereceğim datayı  linkedinpaylas.php ya gönderem orada önce oturumu sorsun anda da işlem tamamsa linkedine göndersin ve geri sonunda bu sayfanın varmaya çalıştığı url ye gitsin  header("Location:?sy=kurumsal&islem=basarili");	en sonunda buraa gibi ,  başarı sayfasında önce paylaş sayfası paylaşta tamam olunca başarıya gelecek nasıl olsa datamız elimizde 
		...
		header("Location:?sy=kurumsal&islem=basarili");	
