...
<?php 
	...
	$cbak = $mysqli->query("select * from   urundokuman  where urunID='$id' order by sira asc ");
...
//		$rhedef				= "../uploads/";
		...
		$guncellee = $mysqli->query("update urundokuman set katID='$katID', baslik='$baslik' , sira='$sira' , dil='$dil' where id='$gizli' ");
...
header("Location:?sy=".$kategori."&id=".$id."&dil=".$dil."&islem=basarili");
	...
	$resim1		= $mysqli->query("select * from urundokuman where id='$gizli'");
