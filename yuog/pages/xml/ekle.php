...
if($_POST){ 
	...
	$gonder  	= $mysqli->query(" insert into bilgi set 
...
<div class="form-group row">
	...
	echo '<a href="?sy=bilgiekle&dil='.$dilyaz1['id'].'&konu='.$konu.'"><button type="button" class="btn btn-raised btn-raised-primary m-1">'.$dilyaz1['baslik'].'</button></a> ';
	
			} else {
			
	echo '<a href="?sy=bilgiekle&dil='.$dilyaz1['id'].'&konu='.$konu.'"><button type="button" class="btn btn-outline-primary m-1">'.$dilyaz1['baslik'].'</button></a> ';
...
-->
 ...
 <div class="form-group row">
		<label for="resim" class="col-sm-2 col-form-label"><i class="nav-icon fa fa-image"></i> İçerik Resmi ( 400 * 261) * </label>
		<div class="col-sm-2">
		  <input type="file" name="resim" class="form-control" id="resim" placeholder="Resim" required  > 
