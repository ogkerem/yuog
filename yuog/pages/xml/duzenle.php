	...
	$id 	= $_GET['id'];
	$yaz1 	= $mysqli->query("select * from bilgi where id='$id' ");
   ...
   <div class="breadcrumb">
	...
	<h1> <a href="?sy=bilgi&konu=<?php echo $konu; ?>">  Menü Genel Açıklama </a> > <a href="?sy=<?php echo $konu; ?>"> <?php echo $konu; ?> </a>  > <?php echo $dilyaz['baslik']; ?> </h1>
...
if($_POST){ 
	...
	$gonder  	= $mysqli->query(" update bilgi set  
	...
	if($gonder){
	 ...
	 //resimler 
		...
		// $guncelle 	= $mysqli->query("update bilgi set ustresim='$resimsonad' where id='$id' ");
	// }	
	...
	if($resimad!=""){ 	 
		...
		$guncelle 	= $mysqli->query("update bilgi set resim='$resimsonad' where id='$id' ");
	}
...
<div class="form-group row">
 	...
 	<script type="text/javascript"> 
		$(function(){
			$("select[name=ustkatID]").change(function(){
				...
				$.ajax({
					url: "pages/kurumsal/ukatbak.php",
					type: "POST",
 ...
 <div class="form-group row">
	 ...
	 <a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['ustresim']; ?>" tkurumsalt="_blank" >
	...
	<a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['icon']; ?>" tkurumsalt="_blank" >
 ...
 -->
	...
	<a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['kresim']; ?>" tkurumsalt="_blank" >
	<img src="../uploads/<?php echo $konu; ?>/<?php echo $yaz['kresim']; ?>" title="Küçük Resim" alt="Küçük Resim" style="background-color:#ddd; width:50px; "></a>
	  ...
	  <div class="form-group row">
		<label for="resim" class="col-sm-2 col-form-label"><i class="nav-icon fa fa-image"></i> Resim  (  400 * 261)*  </label>
		<div class="col-sm-3">
	...
	<a href="../uploads/bilgi/<?php echo $yaz['resim']; ?>" target="_blank" >
	<img src="../uploads/bilgi/<?php echo $yaz['resim']; ?>" title=" Resim" alt=" Resim" style="background-color:#ddd; width:50px; "></a>
	</div>
 ...
 <div class="form-group row">
	...
	<a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['vresim']; ?>" tkurumsalt="_blank" >
	...
	<div class="form-group row">
		...
		<div class="col-sm-4">
		  <a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['pdf']; ?>" tkurumsalt="_blank" ><?php echo $yaz['pdf']; ?></a>
 ...
 <div class="form-group row bg-light p-2" id="yenirsimmm">
	...
	<?php $ressbakk = $mysqli->query("select * from galeri where konu='kurumsal' && icerikID='$id' && durum='1' "); 
	
		while($ressyaz = $ressbakk->fetch_array()){
			
			echo '<div class="col-sm-2">
	   
<a href="../uploads/'.$konu.'/'.$ressyaz['resim'].'" tkurumsalt="_blank" >
