...
if($_POST){ 
	...
	$gonder  	= $mysqli->query(" update acenta set 
	 firma 					='$firma', 
	 yetkili 				='$yetkili', 
	 cep 					='$cep', 
...
?>	
	...
	<div class="form-group row">
		...
		<div class="col-sm-6">
		 <input type="text" name="yetkili" class="form-control" id="yetkili" placeholder="Yetkili Kişi" value="<?php echo $yaz['yetkili']; ?>" >
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-sm-6">
		 <input type="text" name="cep" class="form-control" id="cep" placeholder="Cep Telefonu" value="<?php echo $yaz['cep']; ?>" required >
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-sm-4">
		 <input type="text" name="hesapsahibi" class="form-control" id="hesapsahibi" placeholder="Hesap Sahibi" value="<?php echo $yaz['hesapsahibi']; ?>" >
		</div>
		
		<div class="col-sm-4">
		 <input type="text" name="iban" class="form-control" id="adres" placeholder="IBAN" value="<?php echo $yaz['iban']; ?>" >
		</div>
	</div>
	 ...
	 <div class="form-group row">
		...
		<div class="col-sm-1">
		 <input type="text" name="cari" class="form-control" id="cari" placeholder="Cari" value="<?php echo $yaz['cari']; ?>" required > 
		</div>
	 <div class="col-sm-1">
		 TL 
		</div>
...
<hr/>
	<div class="form-group row">
		...
		<div class="col-sm-10">
		<textarea name="aciklama"   id="aciklama" cols="100%" rows="4"><?php echo $yaz['aciklama']; ?></textarea>
