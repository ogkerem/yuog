   ...
   <div class="breadcrumb">
                <h1><a href="?sy=<?php echo $konu; ?>">Kariyer</a>  >  <?php echo $dilyaz['baslik']; ?>  </h1>
                <ul>
...
<div class="form-group row">
 ...
 <div class="form-group row">
	 ...
	 <a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['ustresim']; ?>" tkariyert="_blank" >
	...
	<a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['icon']; ?>" tkariyert="_blank" >
  ...
  <div class="form-group row">
	...
	<a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['kresim']; ?>" tkariyert="_blank" >
	...
	<a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['resim']; ?>" tkariyert="_blank" >
 ...
 <!-- <div class="form-group row">
	...
	<a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['vresim']; ?>" tkariyert="_blank" >
	...
	<div class="form-group row">
		...
		<div class="col-sm-4">
		  <a href="../uploads/<?php echo $konu; ?>/<?php echo $yaz['pdf']; ?>" tkariyert="_blank" ><?php echo $yaz['pdf']; ?></a>
 ...
 <div class="form-group row bg-light p-2" id="yenirsimmm">
	...
	<?php $ressbakk = $mysqli->query("select * from galeri where konu='kariyer' && icerikID='$id' && durum='1' "); 
	
		while($ressyaz = $ressbakk->fetch_array()){
			
			echo '<div class="col-sm-2">
	   
<a href="../uploads/'.$konu.'/'.$ressyaz['resim'].'" tkariyert="_blank" >
