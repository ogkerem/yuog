...
<div class="breadcrumb">
	...
	<h1> <a href="?sy=sahap&sistem=<?php echo $sistem; ?>"> <?php echo $sistemyaz['menu']; ?> </a> > Markaları </h1>
...
<div class="card-header text-right bg-transparent">
	<!-- <button type="button" data-toggle="modal" data-tmarkat=".bd-example-modal-lg" class="btn btn-primary btn-md m-1"><i class="i-Add-User text-white mr-2"></i> İçerik Ekle </button> -->
