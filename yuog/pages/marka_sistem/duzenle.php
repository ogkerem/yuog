   ...
   <h1> <a href="?sy=sahap&sistem=<?php echo $sistem; ?>"> <?php echo $sistemyaz['menu']; ?> </a> > <a href="?sy=marka&sistem=<?php echo $sistem; ?>"> Markalar </a> > <?php echo $dilyaz['baslik']; ?> </h1>
...
<div class="form-group row">
 ...
 <div class="form-group row">
	 ...
	 <a href="../uploads/<?php echo $yaz['ustresim']; ?>" tmarkat="_blank" >
	 <img src="../uploads/<?php echo $yaz['ustresim']; ?>" title="Büyük Resim" alt="Büyük Resim" style="background-color:#ddd; width:100px; "></a>
	...
	<a href="../uploads/<?php echo $yaz['icon']; ?>" tmarkat="_blank" >
	<img src="../uploads/<?php echo $yaz['icon']; ?>" title="  Resim" alt=" Resim" style="background-color:#ddd; width:50px; "></a>
	</div>
 ...
 <!--
  ...
  <div class="form-group row">
	...
	<a href="../uploads/<?php echo $yaz['vresim']; ?>" tmarkat="_blank" >
	<img src="../uploads/<?php echo $yaz['vresim']; ?>" title=" Resim" alt=" Resim" style="background-color:#ddd; width:50px; "></a>
	</div> 
	 
	<hr>  
 <div class="form-group row bg-light p-2" id="yenirsimmm">
	<label for="resim" class="col-sm-2 col-form-label"><i class="nav-icon i-Data-Upload"></i>  Yeni Dosya Ekle </label>
	
	<div class="col-12">
	<div class="col-sm-2 float-left">
	
	<input type="file" name="dosya[]" multiple="multiple" class="form-control" id="resim" placeholder="Resimler"  style="float:left; " > 
	  <small id="web" class="ul-form__text form-text "> Birden fazla dosya seçebilirsiniz </small>
	 </div>
	...
	<?php $ressbakk = $mysqli->query("select * from dosya where konu='$konu' && icerikID='$id' && durum='1' "); 
	
		while($ressyaz = $ressbakk->fetch_array()){
			
			echo '<div class="col-sm-2">
	   
<a href="../uploads/'.$ressyaz['resim'].'" target="_blank" >'.$ressyaz['resim'].' </a>
<input type="hidden" name="eskidosyalar[]" value="'.$ressyaz['id'].'"> 
	<br/>
	<br/> 
 ...
 <div class="form-group row bg-light p-2" id="yenirsimmm">
	...
	<?php $ressbakk = $mysqli->query("select * from galeri where konu='marka' && icerikID='$id' && durum='1' "); 
