   ...
   <div class="breadcrumb">
                <h1>Kategori Ekleme >  <?php echo $dilyaz['baslik']; ?>  </h1>
                <ul>
                    <li><a href="index.php">Ana Sayfa</a></li>
                    <li><a href="?sy=tsetkat">TPM Setleri Kategoriler</a></li>
...
if($_POST){ 
	...
	$seoekle 		= $mysqli->query("insert into seo (seo,konu, durum) values ('$sonurl', 'tsetkat', '$durum')");	
	...
	if($gonder){
		...
		$esay =  count($ebakp);
		  	...
		  	for($yy=0; $yy < $esay; $yy++){
			$etiket1  = $ebakp[$yy];
		$etiketekle = $mysqli->query ("insert into etiket (`baslik`, `seo`, `konu`, `konuID` ) values ('$etiket1' , '$seoID' , 'tsetkat' , '$icerikID' ) ");
...
<div class="form-group row">
	...
	echo '<a href="?sy=esetlerekle&dil='.$dilyaz1['id'].'"><button type="button" class="btn btn-raised btn-raised-primary m-1">'.$dilyaz1['baslik'].'</button></a> ';
	
			} else {
			
	echo '<a href="?sy=esetlerekle&dil='.$dilyaz1['id'].'"><button type="button" class="btn btn-outline-primary m-1">'.$dilyaz1['baslik'].'</button></a> ';
